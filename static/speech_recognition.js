...
class SpeechRecognition {
  constructor(userInputElement, transcribeUrl) {
    ...
    this.transcribeUrl = transcribeUrl || "/transcribe_audio";
    ...
    // Configuration
    this.config = {
      mimeType: this.getPreferredMimeType(), // Get best supported format
